...
class MenuBarMenu extends Frame implements ActionListener{
	MenuBar mb;
	Menu m1,m2,m3,m4;
	...
	MenuBarMenu(){
		...
		mb = new MenuBar(); //creates a menubar
		...
		mi5 = new MenuItem("New Image FB");
		mi6 = new MenuItem("Undo");
		mi7 = new MenuItem("Redo");
		mi8 = new MenuItem("Cut");
		mi9 = new MenuItem("Exit");
		
		cmi1 = new CheckboxMenuItem("Lagoon");
		cmi2 = new CheckboxMenuItem("Brush Pallette");
